 ...
 */
import acoWargame.InOut.Distance_type;
...
public class Tsp {
     ...
     */
    {
		...
		{ /* compute cnd-sets for all node */	
		    ...
		    Utilities.sort2(distance_vector, help_vector, 0, n - 1);//同时对arg1和arg2对应快排
		    for (i = 0; i < nn; i++)
		    {
