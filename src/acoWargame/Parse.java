...
public class Parse {
	...
	options.addOption("t", "targets", false, "the numbers of enemy targets");//获取目标数目
...
/*	if (cmd.hasOption("t")) {
	...
	if (cmd.hasOption("t")) {//设置敌方目标数目
	    Ants.targets_wargame = Integer.parseInt(cmd.getOptionValue("t"));
	    System.out.println("-m/ants Number of ants with argument " + Ants.targets_wargame);
	} else {
	    //System.out.println("Note: Time limit is set to default " + InOut.max_time + " seconds");
	}
